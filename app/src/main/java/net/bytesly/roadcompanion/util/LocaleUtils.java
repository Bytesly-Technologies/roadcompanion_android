...
public class LocaleUtils {
    ...
    public static String getPrefLangCode(Context context) {
        String defaultLang = context.getResources().getConfiguration().getLocales().get(0).getLanguage();
        if(!defaultLang.equals("en") && !defaultLang.equals("ka")) {
            defaultLang = "ka";
        }
        return PreferenceManager.getDefaultSharedPreferences(context).getString("lang_code",defaultLang);
    }
    ...
    public static  String getPrefCountryCode(Context context) {
        String defaultCountry = context.getResources().getConfiguration().getLocales().get(0).getCountry();
        return PreferenceManager.getDefaultSharedPreferences(context).getString("country_code",defaultCountry);
    }
